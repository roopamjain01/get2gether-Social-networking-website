...
public partial class SiteMember_album : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("viewphoto.aspx?albumid=" + e.CommandName + "");
        }
        ...
        protected void button1_command(object sender, CommandEventArgs e)
        {
           // string albumid = Session["albumid"].ToString();
            ...
            Session["albumid"] = e.CommandName;
            Response.Redirect("upload.aspx?albumid=" + e.CommandName + "");
        }
        ...
        {
            Response.Redirect("album_name.aspx");
        }
