<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMember/design.master" AutoEventWireup="true" CodeFile="deletepost.aspx.cs" Inherits="SiteMember_deletepost" %>
...
<asp:DataList ID="DataList1" runat="server">
    ...
    <ItemTemplate>
         ...
         <tr>
         <td>
             <asp:Button ID="Button1" runat="server"  OnCommand="Button1_command" CommandName='<%# Eval("id") %>'  Text="Delete" Width="100px" OnClientClick="return confirm('Do you want to delete Post...?')" />
             </td>
             </tr>
               <tr>
