<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMember/design.master" AutoEventWireup="true" CodeFile="delfullalbum.aspx.cs" Inherits="SiteMember_delfullalbum" %>
         ...
         <asp:DataList ID="DataList1" runat="server" DataKeyField="albumid"   
            ...
            Width="200px" RepeatColumns="4">
               ...
               <ItemTemplate>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                 <asp:Button ID="Button1" CommandName='<%# Eval("albumid") %>' runat="server" OnCommand="button1_command" Text="Delete" Width="100" OnClientClick="return confirm('Do you want to delete Album...?')" />
                </ItemTemplate>
            </asp:DataList>  
