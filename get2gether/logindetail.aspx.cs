...
public partial class logindetail : System.Web.UI.Page
{
    ...
    {
        cn.Open();
        cmd.CommandText = "select user_name from login where user_name=@username";
        ...
        else
        {
            ...
            cmd.ExecuteNonQuery();
            cmd.Parameters.Clear();
            cmd.CommandText = "insert into login_detail values(@first_name,@last_name,@username,@i_am,@dobdd,@dobmm,@dobyy)";
            ...
            Response.Redirect("SiteMember/welcome.aspx");
    ...
    protected void yy_SelectedIndexChanged(object sender, EventArgs e)
    {
