<%@ Page Language="C#" AutoEventWireup="true" CodeFile="logindetail.aspx.cs" Inherits="logindetail" %>
      ...
      <table cellspacing="0" width="1000px" cellpadding="0" frame="border" 
            ...
            <tr>
               <td width="520px" 
                ...
                <asp:Image ID="Image3" runat="server" ImageUrl="~/images/g2g4.jpg" Width="530" 
                       Height="490px" />
               ...
               <td width="470px">
               <div style="width: 450px" width="480">
...
&nbsp;
                                <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="Calibri" 
                                    ForeColor="#337FC6" PostBackUrl="~/login.aspx">Back to Login Page...</asp:LinkButton>
                                </strong>
                      </td>
